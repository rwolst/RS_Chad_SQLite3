Drop Table IF EXISTS pitching_events;

CREATE Table pitching_events as

SELECT
	BAT_HAND_CD as BatterHand,
...
Create Index pitching_events_idx ON pitching_events (Date, HomeTeam, GameNumber, PlayNumber);